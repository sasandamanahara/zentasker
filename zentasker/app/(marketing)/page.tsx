    ...
    <div className="flex items-center justify-center flex-col">
      ...
      >
        ...
        >
          ...
          World's No 1 task management platform{" "}
        </div>
        <h1 className="text-3xl md:text-6xl text-center text-neutral-800 mb-6">
          Zentasker helps team move
        </h1>
        <div
      ...
      >
        ...
        high rises to the home office, the way you team works is unique-
        accomplish it all with Zentasker....
      </div>
      <Button className="mt-6" size="lg" asChild>
        <Link href="/sign-up">Get Zentasker for free</Link>
      </Button>
    </div>
  );
};
